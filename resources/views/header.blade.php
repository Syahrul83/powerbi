								...
								<div class="header-row">
									<div class="header-logo">
										<a href="/">															<?php  $logo="logo"  ?>
											<img alt="Juwata" width="130" height="48" data-sticky-width="100" data-sticky-height="40" src="/img/{{$logo}}.png">
										</a>
									</div>
								</div>
							</div>
							<div class="header-column justify-content-end">
								...
								<li class="nav-item dropdown nav-item-left-border  d-sm-block nav-item-left-border-remove nav-item-left-border-md-show">
												...
												<div class="dropdown-menu" aria-labelledby="dropdownLanguage">
													<a class="dropdown-item" href="{{ url('locale/id') }}"><img src="/img/blank.gif" class="flag flag-id" alt="Indonesia" /> Indonesia</a>
													<a class="dropdown-item" href="{{ url('locale/pt') }}"><img src="/img/blank.gif" class="flag flag-us" alt="English" /> English</a>
...
<ul class="list list-icons list-icons-lg">
	<li class="mb-1"><i class="far fa-dot-circle text-color-yel"></i><p class="m-0"><a href="#">{{ setting('site.Alamat') }}</a></p></li>
<li class="mb-1"><i class="fas fa-phone text-color-yel"></i>
<p class="m-0"><a href="tel:{{setting('site.Telepon')}}">{{setting('site.Telepon')}}</a></p></li>
	<li class="mb-1"><i class="far fa-envelope text-color-yel"></i>
<p class="m-0">
<a href="mailto:{{setting('site.Email')}}">{{setting('site.Email')}}</a></p></li>								</ul>							</div>						</div>
...
<ul class="social-icons">
  ...
  </div>				</div>				<div class="footer-copyright">					<div class="container py-2">
      <div class="row py-4">
      <div class="col-lg-1 d-flex align-items-center justify-content-center justify-content-lg-start mb-2 mb-lg-0">
								<a href="/index.html" class="logo pr-0 pr-lg-3">
													<img alt="Porto Website Template" src="/img/logo.png" class="opacity-5" height="30">
												</a>
													</div>
