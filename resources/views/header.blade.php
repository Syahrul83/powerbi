																												...
																												<div class="header-row">
																																<div class="header-logo">
																																				<a href="/"> <?php $logo = 'logo'; ?>
																																								<img alt="Juwata" height="48" data-sticky-width="48"
																																				...
																																				<ul class="nav nav-pills">
																																								...
																																								<li
																																												...
																																												<a class="nav-link" href="#" role="button" id="dropdownLanguage"
																																																...
																																																<img src="/img/blank.gif" class="flag flag-{{ $bhs }}"
																																																				alt="Indonesia" /> {{ $bhs1 }}
																																																<i class="fas fa-angle-down"></i>
																																												</a>

																																												<div class="dropdown-menu" aria-labelledby="dropdownLanguage">
																																																<a class="dropdown-item" href="{{ url('locale/id') }}"><img
																																																								src="/img/blank.gif" class="flag flag-id" alt="Indonesia" />
																																																				Indonesia</a>
																																																<a class="dropdown-item" href="{{ url('locale/pt') }}"><img
																												...
																												<div class="header-row">
																																<div class="header-nav pt-1">
																																				...
																																				<ul class="header-social-icons social-icons d-none d-sm-block">
																																								<li class="social-icons-facebook"><a href="/{{ setting('site.Facebook') }}"
																																																target="_blank" title="Facebook"><i
																																																				class="fab fa-facebook-f"></i></a></li>
																																								<li class="social-icons-twitter"><a href="/{{ setting('site.Twitter') }}"
																																																target="_blank" title="Twitter"><i class="fab fa-twitter"></i></a>
																																								</li>
																																								<li class="social-icons-linkedin"><a href="/{{ setting('site.Youtube') }}"
												...
												<div class="container">
																...
																<div class="row my-4 py-5">
																				<div class="col-md-6 col-lg-4 mb-lg-0 mb-4">
																								<a class="twitter-timeline" data-height="170" data-dnt="true" data-theme="dark"
																												href="{{ setting('site.Twitter') }}">Tweets by Power BI</a>
				...
				<li class="appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="1200"><i class="fas fa-wallet"></i><a href="/transport" class="d-block text-color-hover-light ">{{ app()->getLocale() == 'id'? 'Barang Hilang & Ditemukan' : 'Lost and Find Item' }} </a></li> --}}
																								...
																								<div class="contact-details">
																												...
																												<ul class="list list-icons list-icons-lg">
																																...
																																<li class="mb-1"><i class="fas fa-phone text-color-yel"></i>
																																				<p class="m-0"><a
																																												href="tel:{{ setting('site.Telepon') }}">{{ setting('site.Telepon') }}</a>
																																				</p>
																																</li>
																				...
																				<div class="col-md-6 col-lg-2">
																								...
																								<ul class="social-icons">
																												...
																												<li class="social-icons-twitter"><a href="{{ setting('site.Twitter') }}" target="_blank"
												...
												<div class="footer-copyright">
																<div class="container py-2">
																				<div class="row py-4">
																								<div
																												class="col-lg-1 d-flex align-items-center justify-content-center justify-content-lg-start mb-lg-0 mb-2">
																												<a href="/index.html" class="logo pr-lg-3 pr-0">
																																<img alt="Porto Website Template" src="storage/{{ setting('site.logo') }}"
																																				class="opacity-5" height="30">
																												</a>
																								</div>
																								<div
																												class="col-lg-4 d-flex align-items-center justify-content-center justify-content-lg-start mb-lg-0 mb-4">
